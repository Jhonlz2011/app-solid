...
export const ThemeToggle: Component<ThemeToggleProps> = (props) => {
  ...
  return (
    <button
      onClick={toggleTheme}
      class="flex items-center justify-center text-muted hover:bg-card-alt hover:text-text p-1.5 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 focus-visible:ring-offset-transparent focus-visible:text-heading cursor-pointer"
