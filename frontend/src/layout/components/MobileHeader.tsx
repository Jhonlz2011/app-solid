...
const MobileHeader: Component = () => {
    ...
    return (
        <header class="bg-surface/95 backdrop-blur-[12px] border-b border-border pt-[env(safe-area-inset-top)] sm:hidden fixed top-0 left-0 right-0 h-14 z-30 flex items-center justify-between px-3">
            <button
                onClick={openSidebar}
