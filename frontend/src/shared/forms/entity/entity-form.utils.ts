...
export const EMPTY_EMPLOYEE_DETAILS = {
    ...
    approvalLimitAmount: undefined as number | null | undefined,
    accumulateThirteenth: true,
    accumulateFourteenth: true,
    accumulateReserveFunds: true,
    iessCode: '',
    dependentsCount: 0,
    disabilityPercentage: undefined as number | null | undefined,
    conadisId: '',
    bankName: '',
...
export function mapEntityDetailToFormData(
    ...
    return {
        ...
        employeeDetails: e.employeeDetails ? {
            ...
            commissionPercentage: e.employeeDetails.commission_percentage ? Number(e.employeeDetails.commission_percentage) : undefined,
            approvalLimitAmount: e.employeeDetails.approval_limit_amount ? Number(e.employeeDetails.approval_limit_amount) : undefined,
            ...
            disabilityPercentage: e.employeeDetails.disability_percentage ? Number(e.employeeDetails.disability_percentage) : undefined,
            conadisId: e.employeeDetails.conadis_id ?? '',
