...
export function mapEntityDetailToFormData(
    ...
    return {
        ...
        phone: e.phone ?? '',
        isClient: (e.is_client !== null && e.is_client !== undefined) ? true : (fallbackLockedRoles?.isClient ?? false),
        isSupplier: (e.is_supplier !== null && e.is_supplier !== undefined) ? true : (fallbackLockedRoles?.isSupplier ?? false),
        isEmployee: (e.is_employee !== null && e.is_employee !== undefined) ? true : (fallbackLockedRoles?.isEmployee ?? false),
        isCarrier: (e.is_carrier !== null && e.is_carrier !== undefined) ? true : (fallbackLockedRoles?.isCarrier ?? false),
