...
export const PlusIcon: Component<IconProps> = (props) => (
    <svg class={props.class ?? 'size-5'} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
    </svg>
);

export const EditIcon: Component<IconProps> = (props) => (
    <svg class={props.class ?? 'size-4'} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// View icons
export const ViewIcon: Component<IconProps> = (props) => (
    <svg class={props.class ?? 'size-5'} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const CheckIcon: Component<IconProps> = (props) => (
    <svg stroke-width="4" class={props.class ?? 'size-4'} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const SpinnerIcon: Component<IconProps> = (props) => (
    <svg class={`${props.class ?? 'size-5'} animate-spin`} fill="none" viewBox="0 0 24 24">
...
export const SidebarCollapseIcon: Component<IconProps> = (props) => (
    <svg class={props.class ?? 'size-5'} fill="currentColor" viewBox="0 0 20 20">
...
export const PinOffIcon: Component<IconProps> = (props) => (
    <svg class={props.class ?? 'size-4'} fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
