...
export const AvailabilityBadge: Component<AvailabilityBadgeProps> = (props) => {
    ...
    return (
        <Show when={currentStatus() !== 'idle' && currentStatus() !== 'invalid' && currentStatus() !== 'checking'}>
            <div class={cn("inline-flex items-center min-h-[20px] transition-opacity duration-200", props.class)}>
                <Switch>
