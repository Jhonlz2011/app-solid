import { Component, Switch, Match, untrack, createMemo, type Accessor } from 'solid-js';
...
export const AvailabilityBadge: Component<AvailabilityBadgeProps> = (props) => {
    return untrack(() => {
        const currentStatus = createMemo(() => typeof props.status === 'function' ? (props.status as Accessor<AvailabilityStatus>)() : props.status);
