/**
 * SessionItem — Shared session display component
 *
 * Used by both Profile (my sessions) and Users (admin session management).
 * Session type imported from @app/schema/rbac-dto.
 */
import { Component, Show } from 'solid-js';
import { parseUserAgent, formatSessionDate } from '@shared/utils/session.utils';
import type { UserSessionDto } from '@app/schema/rbac-dto';
