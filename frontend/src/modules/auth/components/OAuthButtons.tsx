...
export const GoogleIcon: Component<{ class?: string }> = (props) => (
  <svg class={props.class || "size-4.5"} viewBox="0 0 24 24">
    <path
      fill="#4285F4"
...
export const MicrosoftIcon: Component<{ class?: string }> = (props) => (
  <svg class={props.class || "size-4.5"} viewBox="0 0 23 23">
