import { Component, createSignal, createEffect, For, Show, onCleanup, untrack } from 'solid-js';
...
const BrandingSettings: Component = () => {
    ...
    const form = createForm(() => ({
        ...
        onSubmit: async ({ value }) => {
            updateBrandingMut.mutate(value, {
                ...
                onError: (err: any) => {
                    toast.error(err.message || 'Error al guardar la apariencia');
                }
            });
        },
    }));
    ...
    // Crear URLs de previsualización reactivas
    createEffect(() => {
