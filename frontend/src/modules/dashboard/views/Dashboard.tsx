...
const Dashboard: Component = () => {
  ...
  const latestProducts = () => productsQuery.data?.data ?? [];

  return (
    <div class="p-4 lg:p-6">
      <div class="max-w-7xl mx-auto space-y-6">
        <div class="card-panel rounded-2xl shadow-lg p-6">
          <h1 class="title-primary text-3xl font-bold mb-2">Dashboard ERP</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="stat-card">
            ...
            <p class="title-primary text-3xl font-bold">{'—'}</p>
          ...
          <div class="stat-card">
            ...
            <p class="title-primary text-3xl font-bold">{lowStock()}</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div class="card-panel rounded-xl p-6">
            <div class="flex items-center justify-between mb-4">
              <div>
                <h2 class="title-primary text-xl font-semibold">Órdenes recientes</h2>
            ...
            <div class="space-y-3">
              ...
              >
                <For each={latestProducts()}>
                  {(product) => (
                    <div class="p-3 surface-panel rounded-lg flex items-center justify-between">
                      <div>
                        <p class="title-primary font-semibold">{product.name}</p>
          ...
          <div class="card-panel rounded-xl p-6">
            <h2 class="title-primary text-xl font-semibold mb-4">Sesión y seguridad</h2>
            <div class="space-y-3">
              <div class="flex items-center justify-between p-3 surface-panel rounded-lg">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div class="card-panel rounded-xl p-6">
            <h2 class="title-primary text-xl font-semibold mb-4">Guías recientes</h2>
            <div class="space-y-3">
          ...
          <div class="card-panel rounded-xl p-6">
            <h2 class="title-primary text-xl font-semibold mb-4">Inventario crítico</h2>
            <div class="space-y-3">
              <Show
