/**
 * EmployeesPage — Orchestrator component.
 */
...
// Icons
import {
    PlusIcon, TrashIcon, BriefcaseIcon, DownloadIcon, UploadIcon,
        ...
        <div class="h-full flex flex-col bg-linear-to-br from-background via-background to-surface/20">
            ...
            <div class="shrink-0 p-3 sm:p-4 space-y-4 sm:space-y-5">
                <PageHeader
                    ...
                    info="Gestiona los empleados y personal de la empresa."
                    actions={
                        <div class="flex items-center gap-2">
                            <Button variant="outline" icon={<UploadIcon />} onClick={() => toast.info('Importación próximamente')}>
                                <span class="hidden @sm:inline">Importar</span>
                            </Button>
                            <Show when={state.auth.canAdd('employees')}>
                                <LinkButton to="/employees/new" preload="intent" icon={<PlusIcon />}>
            ...
            <div class="flex-1 min-h-0 px-3 pb-3 sm:px-4 sm:pb-4 overflow-hidden">
                <div class="bg-card border border-border rounded-2xl shadow-card-soft h-full overflow-auto relative">
                    <DataTable
                        ...
                        isLoading={state.employeesQuery.isPending}
                        isPlaceholderData={state.employeesQuery.isPlaceholderData}
            ...
            <ConfirmDialog
                ...
                title={`Eliminar ${state.selectedActiveCount()} empleados`}
                description="Los empleados seleccionados quedarán inactivos. Podrás restaurarlos en cualquier momento."
            ...
            <ConfirmDialog
                ...
                title={`Restaurar ${state.selectedInactiveCount()} empleados`}
                description="Los empleados seleccionados volverán a estar activos."
