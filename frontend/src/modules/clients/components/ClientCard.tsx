/**
 * ClientCard — Mobile card representation of a single client.
 *
 * Displays the most important client data in a compact, tappable card.
        ...
        >
            ...
            <div
                class={cn(
                    ...
                    props.client.is_active ? 'bg-emerald-500' : 'bg-border',
                )}
            />
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="flex items-start justify-between gap-2">
                    ...
                    <StatusBadge isActive={props.client.is_active} />
                </div>

                {/* Row 2: trade name */}
                <Show when={props.client.trade_name}>
                    <p class="text-xs text-muted truncate mt-0.5">
                        {props.client.trade_name}
                    </p>
                </Show>
                ...
                <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    <Badge
                        variant={props.client.person_type === 'JURIDICA' ? 'primary' : 'info'}
                        class="text-[10px] px-1.5 py-0"
                    >
                        {props.client.person_type === 'JURIDICA' ? 'Jurídica' : 'Natural'}
                    </Badge>
                </div>

                <Show when={props.client.email_billing}>
                    <p class="text-xs text-muted truncate mt-0.5">
                        {props.client.email_billing}
                    </p>
                </Show>
            </div>
