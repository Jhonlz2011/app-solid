...
import type { EntityState } from '../hooks/useEntityState';
    ...
    return (
        <div class="h-full flex flex-col bg-linear-to-br from-background via-background to-surface/20">
            ...
            <div class="shrink-0 p-3 sm:p-4 space-y-4 sm:space-y-5">
                <PageHeader
                    ...
                    actions={
                        <div class="flex items-center gap-2">
                            ...
                            <Show when={state.auth.canAdd(props.permissionKey)}>
                                <LinkButton to={props.newRoutePath} preload="intent" icon={<PlusIcon />}>
                ...
                <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                    <SearchInput
                        ...
                        placeholder={`Buscar ${props.entityNamePlural}...`}
                ...
                <div class="bg-card border border-border rounded-2xl shadow-card-soft h-full overflow-auto relative">
                    ...
                    >
                        <DataTable
                            ...
                            isLoading={state.entitiesQuery.isPending}
                            isPlaceholderData={state.entitiesQuery.isPlaceholderData}
            ...
            <ConfirmDialog
                ...
                title={`Eliminar ${state.selectedActiveCount()} ${props.entityNamePlural}`}
                description={`Los ${props.entityNamePlural} seleccionados quedarán inactivos. Podrás restaurarlos en cualquier momento.`}
            ...
            <ConfirmDialog
                ...
                title={`Restaurar ${state.selectedInactiveCount()} ${props.entityNamePlural}`}
                description={`Los ${props.entityNamePlural} seleccionados volverán a estar activos.`}
