...
import { EditIcon, KeyIcon, InfoIcon, DeviceIcon, LogoutIcon, UserHistoryIcon, EyeIcon, EyeOffIcon, CopyIcon } from '@shared/ui/icons';
...
const AUDIT_ACTION_LABELS: Record<string, { label: string; color: string }> = {
    'user.created': { label: 'Creado', color: 'bg-emerald-500/15 text-emerald-600' },
    'user.updated': { label: 'Actualizado', color: 'bg-blue-500/15 text-blue-600' },
    'user.deactivated': { label: 'Desactivado', color: 'bg-amber-500/15 text-amber-600' },
    'user.restored': { label: 'Restaurado', color: 'bg-emerald-500/15 text-emerald-600' },
    'user.destroyed': { label: 'Eliminado', color: 'bg-red-500/15 text-red-600' },
    'user.roles_assigned': { label: 'Roles asignados', color: 'bg-violet-500/15 text-violet-600' },
    'user.role_removed': { label: 'Rol removido', color: 'bg-amber-500/15 text-amber-600' },
    'role.created': { label: 'Rol creado', color: 'bg-emerald-500/15 text-emerald-600' },
    'role.updated': { label: 'Rol actualizado', color: 'bg-blue-500/15 text-blue-600' },
    'role.deleted': { label: 'Rol eliminado', color: 'bg-red-500/15 text-red-600' },
    'permission.updated': { label: 'Permisos', color: 'bg-violet-500/15 text-violet-600' },
    'hierarchy.added': { label: 'Jerarquía añadida', color: 'bg-blue-500/15 text-blue-600' },
    'hierarchy.removed': { label: 'Jerarquía removida', color: 'bg-amber-500/15 text-amber-600' },
};
