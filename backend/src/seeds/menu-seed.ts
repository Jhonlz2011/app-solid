...
const MENU_ITEMS: MenuSeedItem[] = [
    ...
    },
    {
        key: 'inventory',
        label: 'Inventario',
        icon: 'M4 23q-.425 0-.712-.288T3 22V2q0-.425.288-.712T4 1t.713.288T5 2v1h14V2q0-.425.288-.712T20 1t.713.288T21 2v20q0 .425-.288.713T20 23t-.712-.288T19 22v-1H5v1q0 .425-.288.713T4 23m1-12h2V8q0-.425.288-.712T8 7h4q.425 0 .713.288T13 8v3h6V5H5zm0 8h6v-3q0-.425.288-.712T12 15h4q.425 0 .713.288T17 16v3h2v-6H5zm4-8h2V9H9zm4 8h2v-2h-2zm-4-8h2zm4 8h2z',
    ...
    },
    {
        ...
        children: [
            ...
            { key: 'users_roles', label: 'Usuarios, Roles y Permisos', path: '/users', permission_prefix: 'users', sort_order: 1, icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
