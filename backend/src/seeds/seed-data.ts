...
export const MENU_ITEMS: MenuSeedItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { key: 'users_roles', label: 'Usuarios y Roles', path: '/users', path_alias: '/usuarios', permission_prefix: 'users', sort_order: 1, icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', status: 'active' },
            { key: 'audit', label: 'Auditoría', path: '/system/audit', path_alias: '/auditoria', permission_prefix: 'audit', sort_order: 3, icon: 'M9 2a1 1 0 0 0-1 1v1H6a2 2 0 0 0-2 2v14q.2 1.8 2 2h2-2c-1 0-2-1-2-2V6c0-1 1-2 2-2h2v1q0 1 1 1h6q1 0 1-1V4h2c1 0 2 1 2 2v.8V6q-.2-1.8-2-2h-2V3q0-1-1-1zm0 0h6q.9.1 1 1v2q-.1.9-1 1H9a1 1 0 0 1-1-1V3q.1-.9 1-1m7 8a6 6 0 1 0 0 12 6 6 0 0 0 0-12m0 0a6 6 0 1 1 0 12 6 6 0 0 1 0-12m0 4v2.2l1.6 1-1.5-1z', status: 'development' },
        ],
    },
];
