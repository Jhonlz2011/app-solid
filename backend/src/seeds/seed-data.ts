...
export const MENU_ITEMS: MenuSeedItem[] = [
    ...
    },
    {
        ...
        sort_order: 20,
        children: [
            { key: 'products', label: 'Productos', path: '/products', path_alias: '/productos', permission_prefix: 'products', sort_order: 0, icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', status: 'active' },
            { key: 'services', label: 'Servicios', path: '/services', path_alias: '/servicios', permission_prefix: 'services', sort_order: 1, icon: 'M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.1-3.1q.7-.4 1 .2a6 6 0 0 1-8.3 7l-7.9 8a1 1 0 0 1-3-3l8-8a6 6 0 0 1 7-8.2c.4.1.5.7.2 1z', status: 'active' },
            { key: 'categories', label: 'Categorias', path: '/categories', path_alias: '/categorias', permission_prefix: 'categories', sort_order: 2, icon: 'M 7 1.75 C 6.3126052 1.75 5.75 2.3126052 5.75 3 L 5.75 9.171875 C 5.7501274 9.7684673 5.9882382 10.341881 6.4101562 10.763672 L 13.119141 17.472656 C 14.15362 18.515654 15.84638 18.515654 16.880859 17.472656 L 21.472656 12.880859 C 22.515654 11.84638 22.515654 10.15362 21.472656 9.1191406 L 14.763672 2.4101562 C 14.341881 1.988238 13.768467 1.7501274 13.171875 1.75 L 7 1.75 z M 7 2.25 L 13.171875 2.25 C 13.636062 2.2500991 14.081976 2.4353926 14.410156 2.7636719 L 21.119141 9.4726562 C 21.969253 10.315826 21.969253 11.684174 21.119141 12.527344 L 16.527344 17.119141 C 15.684174 17.969253 14.315826 17.969253 13.472656 17.119141 L 6.7636719 10.410156 C 6.4353926 10.081976 6.2500991 9.6360619 6.25 9.171875 L 6.25 3 C 6.25 2.5828253 6.5828253 2.25 7 2.25 z M 10.5 5.75 C 10.088748 5.75 9.75 6.0887476 9.75 6.5 C 9.75 6.9112524 10.088748 7.25 10.5 7.25 C 10.911252 7.25 11.25 6.9112524 11.25 6.5 C 11.25 6.0887476 10.911252 5.75 10.5 5.75 z M 2 6.75 A 0.25 0.25 0 0 0 1.75 7 L 1.75 13.171875 C 1.7501274 13.768467 1.9882381 14.341881 2.4101562 14.763672 L 9.1191406 21.472656 C 10.06707 22.427919 11.586427 22.519597 12.642578 21.685547 A 0.25 0.25 0 0 0 12.683594 21.333984 A 0.25 0.25 0 0 0 12.332031 21.292969 C 11.472237 21.971954 10.244348 21.896803 9.4726562 21.119141 L 2.7636719 14.410156 C 2.4353926 14.081976 2.2500991 13.636062 2.25 13.171875 L 2.25 7 A 0.25 0.25 0 0 0 2 6.75 z ', status: 'active' },
            { key: 'brands', label: 'Marcas', path: '/brands', path_alias: '/marcas', permission_prefix: 'brands', sort_order: 3, icon: 'M7 3a2 2 0 0 0-2 2v15a1 1 0 0 0 1.5.9l4.5-2.6a2 2 0 0 1 2 0l4.5 2.6A1 1 0 0 0 19 20V5a2 2 0 0 0-2-2zm0 0h10a2 2 0 0 1 2 2v15a1 1 0 0 1-1.5.9L13 18.3a2 2 0 0 0-2 0l-4.5 2.6A1 1 0 0 1 5 20V5q.2-1.8 2-2', status: 'active' },
            { key: 'uom', label: 'Unidades de medidas', path: '/uom', path_alias: '/unidades', permission_prefix: 'uom', sort_order: 5, icon: 'M21.3 15.3a2.4 2.4 0 0 1 0 3.4l-2.6 2.6a2.4 2.4 0 0 1-3.4 0L2.7 8.7a2.4 2.4 0 0 1 0-3.4l2.6-2.6a2.4 2.4 0 0 1 3.4 0ZM14.5 12.5l2-2M11.5 9.5l2-2M8.5 6.5l2-2M17.5 15.5l2-2', status: 'active' },
            { key: 'attributes', label: 'Atributos', path: '/attributes', path_alias: '/atributos', permission_prefix: 'attributes', sort_order: 6, icon: 'M4 3a1 1 0 0 0-1 1v7q0 1 1 1h5q1 0 1-1V4q0-1-1-1zm11 0a1 1 0 0 0-1 1v3q0 1 1 1h5q1 0 1-1V4q0-1-1-1zm0 9a1 1 0 0 0-1 1v7q0 1 1 1h5q1 0 1-1v-7q0-1-1-1zM4 16a1 1 0 0 0-1 1v3q0 1 1 1h5q1 0 1-1v-3q0-1-1-1z', status: 'active' }
        ],
    },
    {
        key: 'warehouse',
        ...
        sort_order: 30,
        children: [
            { key: 'inventory', label: 'Inventario', path: '/inventory', path_alias: '/inventario', permission_prefix: 'inventory', sort_order: 0, icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', status: 'development' },
            { key: 'movements', label: 'Movimientos', path: '/movements', path_alias: '/movimientos', permission_prefix: 'movements', sort_order: 1, icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4', status: 'development' },
            { key: 'material_orders', label: 'Pedido de Material', path: '/orders', path_alias: '/pedidos', permission_prefix: 'orders', sort_order: 2, icon: 'M6 2a2 2 0 0 0-2 2v3.8V4c0-1 1-2 2-2h8v5q0 1 1 1h5v12c0 1-1 2-2 2h-3.5H18q1.8-.2 2-2V8q0-1-.7-1.7l-3.6-3.6q-.6-.7-1.7-.8zm8 0q1 0 1.7.7l3.6 3.6q.6.7.6 1.6H15a1 1 0 0 1-1-.9zM6.5 8.4h5.4zM7 11l-1 .2-3 1.9q-1 .5-1 1.8V18a2 2 0 0 0 1 1.8l3 1.8q.4.3 1 .3t1-.2l3-1.9q1-.5 1-1.8V15a2 2 0 0 0-1-1.8l-3-1.8zm0 0 1 .3 3 1.9q1 .6 1 1.7v3.2a2 2 0 0 1-1 1.8l-3 1.8-1 .2V17l4.7-2.8L7 16.9l-4.7-2.7L6.9 17v5l-.9-.3-3-1.9a2 2 0 0 1-1-1.7v-3.2A2 2 0 0 1 3 13l3-1.8zm6.1 1.5v.1h5.2v-.1zm.4 4.6v.1h4.8z', status: 'development' },
            { key: 'reception_materials', label: 'Recepcion de Mercaderia', path: '/reception-materials', path_alias: '/recepcion', permission_prefix: 'reception_materials', sort_order: 3, icon: 'M3 3a1 1 0 0 0-1 1v3q0 1 1 1h1v11q.2 1.8 2 2h2-2c-1 0-2-1-2-2V8h16v11c0 1-1 2-2 2h-2 2q1.8-.2 2-2V8h1q1 0 1-1V4q0-1-1-1zm0 0h18q.9.1 1 1v3q-.1.9-1 1H3a1 1 0 0 1-1-1V4q.1-.9 1-1m9 9-3 3 3-2.9V21v-8.9l3 3V15z', status: 'development' },
            { key: 'locations', label: 'Ubicaciones', path: '/locations', path_alias: '/ubicaciones', permission_prefix: 'locations', sort_order: 4, icon: 'M4 2v20-2h16v2V2v2H4zm0 2h16v8h-8V9q0-1-1-1H9a1 1 0 0 0-1 1v3H4zm5 4h2q.9.1 1 1v3H8V9q.1-.9 1-1m-5 4h16v8h-4v-3q0-1-1-1h-2a1 1 0 0 0-1 1v3H4zm9 4h2q.9.1 1 1v3h-4v-3q.1-.9 1-1', status: 'active' },
            { key: 'shipping_guides', label: 'Guías de Remisión', path: '/shipping-guides', path_alias: '/guias-remision', permission_prefix: 'remission_guides', sort_order: 5, icon: 'M9 2a1 1 0 0 0-1 1v1H6a2 2 0 0 0-2 2v14q.2 1.8 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2V3q0-1-1-1zm0 0h6q1 0 1 1v2q0 1-1 1H9a1 1 0 0 1-1-1V3q0-1 1-1M6 4h2v1q0 1 1 1h6q1 0 1-1V4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6q.2-1.8 2-2M8 11zl.1.1.1-.1zm4 0h4zm-4 5zl.1.1.1-.1zm4 0h4z', status: 'development' },
            { key: 'tool_loans', label: 'Pañol de Herramientas', path: '/tool-loans', path_alias: '/herramientas', permission_prefix: 'tool_loans', sort_order: 6, icon: 'M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.1-3.1q.7-.4 1 .2a6 6 0 0 1-8.3 7l-7.9 8a1 1 0 0 1-3-3l8-8a6 6 0 0 1 7-8.2c.4.1.5.7.2 1z', status: 'active' },
        ],
    },
    {
        key: 'operations',
        ...
        sort_order: 40,
        children: [
            { key: 'work_orders', label: 'Orden de Trabajo', path: '/work-orders', path_alias: '/ordenes-trabajo', permission_prefix: 'work_orders', sort_order: 0, icon: 'M4 5a2 2 0 0 0-2 2v2q1.5 0 2.2 1 .7.8.7 2a3 3 0 0 1-.7 2q-.7 1-2.2 1v2q.2 1.8 2 2h16q1.8-.2 2-2v-2q-1.5 0-2.2-1a3 3 0 0 1-.7-2q0-1.1.7-2 .7-1 2.2-1V7q-.2-1.8-2-2H4m0 0h9v2-2h7c1 0 2 1 2 2v2a3 3 0 0 0-2.3.9q-.8.9-.8 2.1t.8 2.1a3 3 0 0 0 2.2 1V17c0 1-.8 2-1.9 2h-7v-2 2H4c-1 0-2-1-2-2v-2a3 3 0 0 0 2.3-.9q.8-.9.8-2.1t-.8-2.1a3 3 0 0 0-2.2-1V7C2 6 2.9 5 4 5m9 6v2z', status: 'development' },
            { key: 'schedule', label: 'Cronograma', path: '/order-schedule', path_alias: '/cronograma', permission_prefix: 'schedule', sort_order: 1, icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', status: 'development' },
            { key: 'project_history', label: 'Historial de Proyectos', path: '/history', path_alias: '/historial', permission_prefix: 'projects', sort_order: 2, icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', status: 'development' },
        ],
    },
    {
        key: 'production',
        ...
        sort_order: 50,
        children: [
            { key: 'planning', label: 'Planificación', path: '/planning', path_alias: '/planificacion', permission_prefix: 'planning', sort_order: 0, icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', status: 'development' },
            { key: 'bom', label: 'Recetas', path: '/bom', path_alias: '/recetas', permission_prefix: 'bom', sort_order: 1, icon: 'M8 2v2H6a2 2 0 0 0-2 2v14q.2 1.8 2 2h12q1.8-.2 2-2V6q-.2-1.8-2-2h-2V2v2H8zM6 4h2v2-2h4v2-2h4v2-2h2c1 0 2 1 2 2v14c0 1-1 2-2 2H6c-1 0-2-1-2-2V6c0-1 1-2 2-2m2 6h6zm0 4h8zm0 4h5z', status: 'development' },
            { key: 'dispatch_requests', label: 'Solicitud de Despacho', path: '/dispatch-requests', path_alias: '/despachos', permission_prefix: 'dispatch_requests', sort_order: 2, icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z', status: 'development' },
        ],
    },
    {
        key: 'purchases',
