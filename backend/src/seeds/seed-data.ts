...
export const MENU_ITEMS: MenuSeedItem[] = [
    ...
    },
    {
        ...
        sort_order: 10,
        children: [
            { key: 'clients', label: 'Clientes', path: '/clients', permission_prefix: 'clients', sort_order: 0, icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', status: 'active' },
    ...
    },
    {
        ...
        children: [
            ...
            { key: 'services', label: 'Servicios', path: '/services', permission_prefix: 'services', sort_order: 1, icon: 'M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.1-3.1q.7-.4 1 .2a6 6 0 0 1-8.3 7l-7.9 8a1 1 0 0 1-3-3l8-8a6 6 0 0 1 7-8.2c.4.1.5.7.2 1z', status: 'active' },
            ...
            { key: 'brands', label: 'Marcas', path: '/brands', permission_prefix: 'brands', sort_order: 3, icon: 'M7 3a2 2 0 0 0-2 2v15a1 1 0 0 0 1.5.9l4.5-2.6a2 2 0 0 1 2 0l4.5 2.6A1 1 0 0 0 19 20V5a2 2 0 0 0-2-2zm0 0h10a2 2 0 0 1 2 2v15a1 1 0 0 1-1.5.9L13 18.3a2 2 0 0 0-2 0l-4.5 2.6A1 1 0 0 1 5 20V5q.2-1.8 2-2', status: 'active' },
            { key: 'uom', label: 'Unidades de medidas', path: '/uom', permission_prefix: 'uom', sort_order: 5, icon: 'M21.3 15.3a2.4 2.4 0 0 1 0 3.4l-2.6 2.6a2.4 2.4 0 0 1-3.4 0L2.7 8.7a2.4 2.4 0 0 1 0-3.4l2.6-2.6a2.4 2.4 0 0 1 3.4 0ZM14.5 12.5l2-2M11.5 9.5l2-2M8.5 6.5l2-2M17.5 15.5l2-2', status: 'active' },
    ...
    },
    {
        ...
        children: [
            ...
            { key: 'users_roles', label: 'Usuarios y Roles', path: '/users', permission_prefix: 'users', sort_order: 1, icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', status: 'active' },
