...
export const MENU_ITEMS: MenuSeedItem[] = [
    ...
    },
    {
        ...
        sort_order: 10,
        children: [
            { key: 'clients', label: 'Clientes', path: '/clients', permission_prefix: 'clients', sort_order: 0, icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', status: 'development' },
            { key: 'technical_visits', label: 'Visitas Técnicas', path: '/visits', permission_prefix: 'visits', sort_order: 1, icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7', status: 'development' },
            { key: 'budgets', label: 'Presupuestos', path: '/budgets', permission_prefix: 'budgets', sort_order: 2, icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z', status: 'development' },
            { key: 'invoicing', label: 'Facturación', path: '/invoices', permission_prefix: 'invoices', sort_order: 3, icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', status: 'development' },
        ],
    },
    {
        key: 'catalog',
    ...
    },
    {
        ...
        sort_order: 30,
        children: [
            { key: 'inventory', label: 'Inventario', path: '/inventory', permission_prefix: 'inventory', sort_order: 0, icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', status: 'development' },
            { key: 'movements', label: 'Movimientos', path: '/movements', permission_prefix: 'movements', sort_order: 1, icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4', status: 'development' },
            ...
            { key: 'locations', label: 'Ubicaciones', path: '/locations', permission_prefix: 'locations', sort_order: 4, icon: 'M4 2v20-2h16v2V2v2H4zm0 2h16v8h-8V9q0-1-1-1H9a1 1 0 0 0-1 1v3H4zm5 4h2q.9.1 1 1v3H8V9q.1-.9 1-1m-5 4h16v8h-4v-3q0-1-1-1h-2a1 1 0 0 0-1 1v3H4zm9 4h2q.9.1 1 1v3h-4v-3q.1-.9 1-1', status: 'development' },
    ...
    },
    {
        ...
        children: [
            ...
            { key: 'schedule', label: 'Cronograma', path: '/order-schedule', permission_prefix: 'schedule', sort_order: 1, icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', status: 'development' },
            { key: 'project_history', label: 'Historial de Proyectos', path: '/history', permission_prefix: 'projects', sort_order: 2, icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', status: 'development' },
        ],
    },
    {
        key: 'production',
        ...
        sort_order: 50,
        children: [
            { key: 'planning', label: 'Planificación', path: '/planning', permission_prefix: 'planning', sort_order: 0, icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', status: 'development' },
            { key: 'bom', label: 'Recetas', path: '/bom', permission_prefix: 'bom', sort_order: 1, icon: 'M8 2v2H6a2 2 0 0 0-2 2v14q.2 1.8 2 2h12q1.8-.2 2-2V6q-.2-1.8-2-2h-2V2v2h-4V2v2H8zM6 4h2v2-2h4v2-2h4v2-2h2c1 0 2 1 2 2v14c0 1-1 2-2 2H6c-1 0-2-1-2-2V6c0-1 1-2 2-2m2 6h6zm0 4h8zm0 4h5z', status: 'development' },
            { key: 'dispatch_requests', label: 'Solicitud de Despacho', path: '/dispatch-requests', permission_prefix: 'dispatch_requests', sort_order: 2, icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z', status: 'development' },
        ],
    },
    {
        key: 'purchases',
        ...
        children: [
            ...
            { key: 'purchase_quotes', label: 'Cotización de Compra', path: '/purchase-quotes', permission_prefix: 'purchase_quotes', sort_order: 1, icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', status: 'development' },
            { key: 'purchase_orders', label: 'Órdenes de Compra', path: '/purchase-orders', permission_prefix: 'purchase_orders', sort_order: 2, icon: 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z', status: 'development' },
            ...
            { key: 'retentions', label: 'Retenciones', path: '/retentions', permission_prefix: 'retentions', sort_order: 4, icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z', status: 'development' },
        ],
    },
    {
        key: 'pos',
    ...
    },
    {
        ...
        sort_order: 80,
        children: [
            { key: 'accounts_receivable', label: 'Cuentas por Cobrar', path: '/receivable', permission_prefix: 'receivable', sort_order: 0, icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', status: 'development' },
            { key: 'accounts_payable', label: 'Cuentas por Pagar', path: '/payable', permission_prefix: 'payable', sort_order: 1, icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z', status: 'development' },
            { key: 'electronic_docs', label: 'Documentos Electrónicos', path: '/documents', permission_prefix: 'documents', sort_order: 3, icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', status: 'development' },
        ],
    },
    {
        key: 'hr',
        ...
        children: [
            ...
            { key: 'hours_report', label: 'Reporte de Horas', path: '/hours', permission_prefix: 'hours', sort_order: 2, icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', status: 'development' },
        ],
    },
    {
        key: 'system',
        ...
        sort_order: 100,
        children: [
            { key: 'general_config', label: 'Configuración General', path: '/settings', permission_prefix: 'config', sort_order: 0, icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z', status: 'development' },
            { key: 'users_roles', label: 'Usuarios y Roles', path: '/users', permission_prefix: 'users', sort_order: 1, icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', status: 'development' },
