...
CREATE TABLE "inventory_stock" (
	...
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "inventory_stock_warehouse_id_product_id_condition_pk" PRIMARY KEY("warehouse_id","product_id","condition")
);
--> statement-breakpoint
...
ALTER TABLE "inventory_dimensional_items" ADD CONSTRAINT "inventory_dimensional_items_warehouse_id_warehouses_id_fk" FOREIGN KEY ("warehouse_id") REFERENCES "public"."warehouses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventory_dimensional_items" ADD CONSTRAINT "inventory_dimensional_items_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_active_suppliers" ON "entities" USING btree ("id") WHERE "entities"."is_supplier" = true AND "entities"."is_active" = true;--> statement-breakpoint
...
CREATE INDEX "idx_inv_stock_product" ON "inventory_stock" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX "idx_inv_stock_condition" ON "inventory_stock" USING btree ("condition");--> statement-breakpoint
...
CREATE INDEX "idx_pos_sessions_register" ON "pos_sessions" USING btree ("cash_register_id","status");