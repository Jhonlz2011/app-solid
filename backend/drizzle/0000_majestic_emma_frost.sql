...
CREATE TYPE "public"."product_class" AS ENUM('MATERIAL', 'TOOL', 'EPP', 'ASSET', 'SERVICE', 'MANUFACTURED');--> statement-breakpoint
...
CREATE INDEX "idx_dim_items_avail" ON "inventory_dimensional_items" USING btree ("product_id","length_mm","width_mm") WHERE status = 'AVAILABLE';--> statement-breakpoint
...
CREATE INDEX "idx_wo_status" ON "work_orders" USING btree ("status");