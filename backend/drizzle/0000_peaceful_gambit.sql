...
CREATE TYPE "public"."contract_type" AS ENUM('INDEFINIDO', 'EVENTUAL', 'PLAZO_FIJO', 'OBRA_CIERTA', 'PASANTIA', 'SERVICIOS_PROFESIONALES');--> statement-breakpoint
...
CREATE TYPE "public"."menu_item_status" AS ENUM('active', 'development', 'deprecated');--> statement-breakpoint
...
CREATE TYPE "public"."salary_type" AS ENUM('SBU', 'CUSTOM');--> statement-breakpoint
...
CREATE TYPE "public"."tool_item_status" AS ENUM('AVAILABLE', 'ON_LOAN', 'IN_MAINTENANCE', 'RETIRED');--> statement-breakpoint
CREATE TYPE "public"."tool_loan_status" AS ENUM('DRAFT', 'DISPATCHED', 'PARTIALLY_RETURNED', 'COMPLETED', 'OVERDUE', 'CANCELLED');--> statement-breakpoint
CREATE TYPE "public"."tool_tracking_mode" AS ENUM('BY_QUANTITY', 'SERIALIZED');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "carrier_vehicles" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE TABLE "employee_details" (
	...
	"salary_type" "salary_type" DEFAULT 'SBU' NOT NULL,
	"salary_base" numeric(10, 2),
	"cost_per_hour" numeric(10, 2),
	"accumulate_thirteenth" boolean DEFAULT true NOT NULL,
	"accumulate_fourteenth" boolean DEFAULT true NOT NULL,
	"accumulate_reserve_funds" boolean DEFAULT true NOT NULL,
	"iess_code" text,
...
CREATE TABLE "companies" (
	...
	"rimpe_type" "tax_regime_type",
	"sbu" numeric(10, 2) DEFAULT '482.00' NOT NULL,
	"sri_environment" text DEFAULT '2' NOT NULL,
	"logo_url" text,
	"primary_color" text DEFAULT '#2563eb' NOT NULL,
	"theme_color" text DEFAULT '#64748b' NOT NULL,
	"login_bg_url" text,
	"email" text,
	"phone" text,
	"is_active" boolean DEFAULT true NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "category_attributes" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "uom" (
...
CREATE TABLE "auth_role_permissions" (
	...
	"company_id" integer NOT NULL,
	CONSTRAINT "auth_role_permissions_role_id_permission_slug_pk" PRIMARY KEY("role_id","permission_slug")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "product_uom_conversions" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "product_variants" (
	...
	"is_active" boolean DEFAULT true,
	"sort_order" integer DEFAULT 0,
	CONSTRAINT "unq_variant_sku_company" UNIQUE("company_id","sku"),
	CONSTRAINT "unq_variant_id_company" UNIQUE("id","company_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "variant_price_history" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "inventory_dimensional_items" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE TABLE "warehouse_locations" (
	...
	CONSTRAINT "unq_location_id_warehouse" UNIQUE("id","warehouse_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "technical_visits" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "bom_details" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "bom_template_details" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "employee_work_schedules" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "manufacturing_log" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "manufacturing_order_inputs" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "work_order_items" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE TABLE "request_templates" (
	...
	"description" text,
	"is_active" boolean DEFAULT true,
	CONSTRAINT "unq_request_template_name" UNIQUE("company_id","name")
);
--> statement-breakpoint
ALTER TABLE "request_templates" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "product_variant_warehouse_locations" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE TABLE "price_list_items" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "chk_price_list_target" CHECK (num_nonnulls(product_id, variant_id) = 1)
);
--> statement-breakpoint
CREATE TABLE "price_lists" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "unq_price_list_name_company" UNIQUE("company_id","name"),
	CONSTRAINT "unq_price_list_id_company" UNIQUE("id","company_id")
);
--> statement-breakpoint
ALTER TABLE "price_lists" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "tool_items" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "tool_items_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"company_id" integer NOT NULL,
	"variant_id" integer NOT NULL,
	"serial_number" text,
	"internal_code" text NOT NULL,
	"status" "tool_item_status" DEFAULT 'AVAILABLE' NOT NULL,
	"condition" "condition" DEFAULT 'GOOD' NOT NULL,
	"location_id" integer,
	"notes" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "unq_tool_item_code_company" UNIQUE("company_id","internal_code")
);
--> statement-breakpoint
ALTER TABLE "tool_items" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "tool_loan_items" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "tool_loan_items_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"loan_id" integer NOT NULL,
	"variant_id" integer NOT NULL,
	"tool_item_id" integer,
	"quantity_loaned" numeric(12, 4) NOT NULL,
	"quantity_returned" numeric(12, 4) DEFAULT '0' NOT NULL,
	"notes" text
);
--> statement-breakpoint
CREATE TABLE "tool_loans" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "tool_loans_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"company_id" integer NOT NULL,
	"code" text NOT NULL,
	...
	"status" "tool_loan_status" DEFAULT 'DISPATCHED' NOT NULL,
	"notes" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "unq_tool_loan_code_company" UNIQUE("company_id","code")
);
--> statement-breakpoint
ALTER TABLE "tool_loans" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "tool_return_items" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "tool_return_items_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"return_id" integer NOT NULL,
...
CREATE TABLE "tool_returns" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "tool_returns_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"loan_id" integer NOT NULL,
...
ALTER TABLE "employee_details" ADD CONSTRAINT "employee_details_department_id_departments_id_fk" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "employee_details" ADD CONSTRAINT "employee_details_job_title_id_job_titles_id_fk" FOREIGN KEY ("job_title_id") REFERENCES "public"."job_titles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "employee_details" ADD CONSTRAINT "employee_details_reports_to_entities_id_fk" FOREIGN KEY ("reports_to") REFERENCES "public"."entities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "entities" ADD CONSTRAINT "entities_default_price_list_id_price_lists_id_fk" FOREIGN KEY ("default_price_list_id") REFERENCES "public"."price_lists"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "category_attributes" ADD CONSTRAINT "category_attributes_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "product_components" ADD CONSTRAINT "product_components_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "product_uom_conversions" ADD CONSTRAINT "product_uom_conversions_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "product_variants" ADD CONSTRAINT "fk_variant_product_tenant" FOREIGN KEY ("product_id","company_id") REFERENCES "public"."products"("id","company_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "variant_price_history" ADD CONSTRAINT "variant_price_history_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "variant_price_history" ADD CONSTRAINT "variant_price_history_changed_by_user_id_fk" FOREIGN KEY ("changed_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "supplier_products" ADD CONSTRAINT "supplier_products_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "inventory_dimensional_items" ADD CONSTRAINT "inventory_dimensional_items_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "quotation_items" ADD CONSTRAINT "quotation_items_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "technical_visits" ADD CONSTRAINT "technical_visits_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "bom_details" ADD CONSTRAINT "bom_details_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "bom_headers" ADD CONSTRAINT "bom_headers_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "bom_template_details" ADD CONSTRAINT "bom_template_details_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "employee_work_schedules" ADD CONSTRAINT "employee_work_schedules_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "manufacturing_log" ADD CONSTRAINT "manufacturing_log_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "manufacturing_log" ADD CONSTRAINT "manufacturing_log_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "manufacturing_order_inputs" ADD CONSTRAINT "manufacturing_order_inputs_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "manufacturing_order_inputs" ADD CONSTRAINT "manufacturing_order_inputs_added_by_user_id_fk" FOREIGN KEY ("added_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "manufacturing_orders" ADD CONSTRAINT "manufacturing_orders_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "work_order_items" ADD CONSTRAINT "work_order_items_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "work_order_items" ADD CONSTRAINT "work_order_items_variant_id_product_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."product_variants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "request_templates" ADD CONSTRAINT "request_templates_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "invoice_payments" ADD CONSTRAINT "invoice_payments_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "pos_sales" ADD CONSTRAINT "pos_sales_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "pos_sessions" ADD CONSTRAINT "pos_sessions_opened_by_user_id_fk" FOREIGN KEY ("opened_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pos_sessions" ADD CONSTRAINT "pos_sessions_closed_by_user_id_fk" FOREIGN KEY ("closed_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "purchase_quotes" ADD CONSTRAINT "purchase_quotes_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_variant_warehouse_locations" ADD CONSTRAINT "product_variant_warehouse_locations_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_variant_warehouse_locations" ADD CONSTRAINT "fk_pvwl_variant_tenant" FOREIGN KEY ("variant_id","company_id") REFERENCES "public"."product_variants"("id","company_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_variant_warehouse_locations" ADD CONSTRAINT "fk_pvwl_warehouse_tenant" FOREIGN KEY ("warehouse_id","company_id") REFERENCES "public"."warehouses"("id","company_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_variant_warehouse_locations" ADD CONSTRAINT "fk_pvwl_location_warehouse" FOREIGN KEY ("default_location_id","warehouse_id") REFERENCES "public"."warehouse_locations"("id","warehouse_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tool_items" ADD CONSTRAINT "tool_items_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_items" ADD CONSTRAINT "tool_items_variant_id_product_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."product_variants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_items" ADD CONSTRAINT "tool_items_location_id_warehouse_locations_id_fk" FOREIGN KEY ("location_id") REFERENCES "public"."warehouse_locations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_loan_items" ADD CONSTRAINT "tool_loan_items_loan_id_tool_loans_id_fk" FOREIGN KEY ("loan_id") REFERENCES "public"."tool_loans"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_loan_items" ADD CONSTRAINT "tool_loan_items_variant_id_product_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."product_variants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_loan_items" ADD CONSTRAINT "tool_loan_items_tool_item_id_tool_items_id_fk" FOREIGN KEY ("tool_item_id") REFERENCES "public"."tool_items"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_loans" ADD CONSTRAINT "tool_loans_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_loans" ADD CONSTRAINT "tool_loans_borrower_id_entities_id_fk" FOREIGN KEY ("borrower_id") REFERENCES "public"."entities"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_loans" ADD CONSTRAINT "tool_loans_dispatched_by_entities_id_fk" FOREIGN KEY ("dispatched_by") REFERENCES "public"."entities"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_loans" ADD CONSTRAINT "tool_loans_work_order_id_work_orders_id_fk" FOREIGN KEY ("work_order_id") REFERENCES "public"."work_orders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_return_items" ADD CONSTRAINT "tool_return_items_return_id_tool_returns_id_fk" FOREIGN KEY ("return_id") REFERENCES "public"."tool_returns"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_employee_details_department" ON "employee_details" USING btree ("department_id");--> statement-breakpoint
CREATE INDEX "idx_employee_details_job_title" ON "employee_details" USING btree ("job_title_id");--> statement-breakpoint
CREATE INDEX "idx_employee_details_reports_to" ON "employee_details" USING btree ("reports_to");--> statement-breakpoint
...
CREATE INDEX "idx_active_clients" ON "entities" USING btree ("company_id","business_name","id") WHERE "entities"."is_client" = true;--> statement-breakpoint
CREATE INDEX "idx_active_suppliers" ON "entities" USING btree ("company_id","business_name","id") WHERE "entities"."is_supplier" = true;--> statement-breakpoint
CREATE INDEX "idx_active_employees" ON "entities" USING btree ("company_id","business_name","id") WHERE "entities"."is_employee" = true;--> statement-breakpoint
CREATE INDEX "idx_active_carriers" ON "entities" USING btree ("company_id","business_name","id") WHERE "entities"."is_carrier" = true;--> statement-breakpoint
CREATE INDEX "idx_entities_company_business_name" ON "entities" USING btree ("company_id","business_name","id");--> statement-breakpoint
CREATE INDEX "idx_entities_company_created_at" ON "entities" USING btree ("company_id","created_at","id");--> statement-breakpoint
CREATE INDEX "idx_entity_addresses_entity_id" ON "entity_addresses" USING btree ("entity_id");--> statement-breakpoint
CREATE INDEX "idx_entity_contacts_entity_id" ON "entity_contacts" USING btree ("entity_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_job_titles_company_name" ON "job_titles" USING btree ("company_id","name");--> statement-breakpoint
...
CREATE INDEX "idx_cat_attrs_company" ON "category_attributes" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_vph_company" ON "variant_price_history" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_sp_company" ON "supplier_products" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_dim_items_company" ON "inventory_dimensional_items" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_movements_company" ON "inventory_movements" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_inv_stock_variant" ON "inventory_stock" USING btree ("variant_id");--> statement-breakpoint
CREATE INDEX "idx_inv_stock_company" ON "inventory_stock" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_quotation_items_company" ON "quotation_items" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_quotation_items_quotation" ON "quotation_items" USING btree ("quotation_id");--> statement-breakpoint
CREATE INDEX "idx_quotations_company" ON "quotations" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_visits_company" ON "technical_visits" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_bom_details_company" ON "bom_details" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_bom_headers_product" ON "bom_headers" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX "idx_bom_headers_company" ON "bom_headers" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_bom_tpl_details_company" ON "bom_template_details" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_schedule_company" ON "employee_work_schedules" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_mfg_log_company" ON "manufacturing_log" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_mfg_inputs_order" ON "manufacturing_order_inputs" USING btree ("manufacturing_order_id");--> statement-breakpoint
CREATE INDEX "idx_mfg_inputs_company" ON "manufacturing_order_inputs" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_mfg_orders_company" ON "manufacturing_orders" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_wo_items_variant" ON "work_order_items" USING btree ("variant_id");--> statement-breakpoint
CREATE INDEX "idx_wo_items_company" ON "work_order_items" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_request_templates_company" ON "request_templates" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "idx_pvwl_company" ON "product_variant_warehouse_locations" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_pvwl_location" ON "product_variant_warehouse_locations" USING btree ("default_location_id");--> statement-breakpoint
...
CREATE INDEX "idx_price_list_items_variant" ON "price_list_items" USING btree ("variant_id");--> statement-breakpoint
CREATE INDEX "idx_price_lists_company" ON "price_lists" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_tool_items_variant" ON "tool_items" USING btree ("variant_id");--> statement-breakpoint
CREATE INDEX "idx_tool_items_status" ON "tool_items" USING btree ("company_id","status");--> statement-breakpoint
CREATE INDEX "idx_tool_items_company" ON "tool_items" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_tli_loan" ON "tool_loan_items" USING btree ("loan_id");--> statement-breakpoint
CREATE INDEX "idx_tli_variant" ON "tool_loan_items" USING btree ("variant_id");--> statement-breakpoint
CREATE INDEX "idx_tli_tool_item" ON "tool_loan_items" USING btree ("tool_item_id");--> statement-breakpoint
CREATE INDEX "idx_tool_loans_borrower" ON "tool_loans" USING btree ("borrower_id","status");--> statement-breakpoint
CREATE INDEX "idx_tool_loans_status" ON "tool_loans" USING btree ("company_id","status");--> statement-breakpoint
CREATE INDEX "idx_tool_loans_wo" ON "tool_loans" USING btree ("work_order_id");--> statement-breakpoint
CREATE INDEX "idx_tool_loans_dates" ON "tool_loans" USING btree ("expected_return_date","status");--> statement-breakpoint
CREATE INDEX "idx_tool_loans_company" ON "tool_loans" USING btree ("company_id");--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "job_titles" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "product_components" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "product_uom_conversions" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "product_variants" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "variant_price_history" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "supplier_products" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "inventory_dimensional_items" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "inventory_movements" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "inventory_stock" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "quotation_items" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "quotations" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "technical_visits" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "bom_details" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "bom_headers" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "bom_template_details" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "employee_work_schedules" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "manufacturing_log" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "manufacturing_order_inputs" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "manufacturing_orders" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "work_order_items" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "request_templates" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "purchase_quotes" AS PERMISSIVE FOR ALL TO public USING (company_id = current_setting('app.current_company_id', true)::integer) WITH CHECK (company_id = current_setting('app.current_company_id', true)::integer);--> statement-breakpoint
